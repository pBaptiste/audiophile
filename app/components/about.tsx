    ...
    return (
        <div className='flex flex-col xl:flex-row'>
            ...
            <div className='flex flex-col xl:justify-center xl:pr-[120px] text-center xl:text-start xl:basis-1/2 text-black'>
                <h4 className='font-bold text-[1.75rem] md:text-[2.5rem] leading-[2.375rem] md:leading-[2.75rem] tracking-[1px] md:tracking-[1.42857px] uppercase mb-8'>Bringing you the <span className='text-custom-orange'>best</span> audio gear</h4>
